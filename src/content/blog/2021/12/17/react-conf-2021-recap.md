...
date: 2021/12/17
description: На прошлой неделе мы провели 6-ю конференцию React Conf. В предыдущие годы мы использовали сцену React Conf для объявления важных для индустрии новостей, таких как React Native и React Hooks. В этом году мы поделились нашим видением React для различных платформ, начиная с выпуска React 18 и постепенного внедрения конкурентных функций.
---

17 декабря 2021 г. [Jesslyn Tannady](https://twitter.com/jtannady) и [Rick Hanlon](https://twitter.com/rickhanlonii)

---

<Intro>

На прошлой неделе мы провели 6-ю конференцию React Conf. В предыдущие годы мы использовали сцену React Conf для объявления важных для индустрии новостей, таких как [_React Native_](https://engineering.fb.com/2015/03/26/android/react-native-bringing-modern-web-techniques-to-mobile/) и [_React Hooks_](https://reactjs.org/docs/hooks-intro.html). В этом году мы поделились нашим видением React для различных платформ, начиная с выпуска React 18 и постепенного внедрения конкурентных функций.

</Intro>

---

Это была первая онлайн-конференция React Conf, и она транслировалась бесплатно с переводом на 8 языков. Участники со всего мира присоединились к нашему конференционному Discord и к просмотру записи мероприятия для удобства во всех часовых поясах. Было зарегистрировано более 50 000 человек, более 60 000 просмотров 19 докладов и 5 000 участников в Discord на обоих мероприятиях.
...
В основной презентации мы поделились нашим видением будущего React, начиная с React 18.

React 18 добавляет долгожданный конкурентный рендерер и обновления для Suspense без каких-либо серьезных нарушений совместимости. Приложения могут обновиться до React 18 и начать постепенно внедрять конкурентные функции с объемом усилий, сопоставимым с любым другим основным выпуском.

**Это означает, что нет никакого конкурентного режима, только конкурентные функции.**

В основной презентации мы также поделились нашим видением Suspense, Server Components, новых рабочих групп React и нашего долгосрочного видения React Native для множества платформ.

Посмотрите полную основную презентацию от [Andrew Clark](https://twitter.com/acdlite), [Juan Tejada](https://twitter.com/_jstejada), [Lauren Tan](https://twitter.com/potetotes) и [Rick Hanlon](https://twitter.com/rickhanlonii) здесь:

<YouTubeIframe src="https://www.youtube.com/embed/FZ0cG47msEk" />

## React 18 для разработчиков приложений {/*react-18-for-application-developers*/}

В основной презентации мы также объявили, что React 18 RC доступен для тестирования. При условии дальнейших отзывов, это будет точная версия React, которую мы опубликуем как стабильную в начале следующего года.
...
Потоковая серверная отрисовка позволяет генерировать HTML из React-компонентов на сервере и передавать этот HTML пользователям. В React 18 вы можете использовать `Suspense` для разбиения вашего приложения на меньшие независимые блоки, которые могут передаваться независимо друг от друга, не блокируя остальную часть приложения. Это означает, что пользователи увидят ваш контент раньше и смогут начать взаимодействовать с ним намного быстрее.
...
Заглядывая в более отдаленное будущее, [Xuan Huang (黄玄)](https://twitter.com/Huxpro) поделился обновлением из наших исследований React Labs об автоматически мемоизирующем компиляторе. Посмотрите этот доклад для получения дополнительной информации и демонстрации прототипа компилятора:

<YouTubeIframe src="https://www.youtube.com/embed/lGEMwh32soc" />

## Основная презентация документации React {/*react-docs-keynote*/}

[Rachel Nabors](https://twitter.com/rachelnabors) открыла секцию докладов об изучении и проектировании с React основной презентацией о наших инвестициях в новую документацию React ([теперь доступна на react.dev](/blog/2023/03/16/introducing-react-dev)):

<YouTubeIframe src="https://www.youtube.com/embed/mneDaMYOKP8" />

## И многое другое... {/*and-more*/}

**Мы также услышали доклады об изучении и проектировании с React:**
...
**И доклады от сообщества об доступности, инструментах и Server Components:**
...
Спасибо [Lauren Tan](https://twitter.com/potetotes) за настройку конференционного Discord и за работу в качестве нашего администратора Discord.

Спасибо [Seth Webster](https://twitter.com/sethwebster) за отзывы об общем направлении и за то, что он следил за тем, чтобы мы сосредоточились на разнообразии и инклюзивности.
...
Спасибо Laura Podolak Waddell, Desmond Osei-Acheampong, Mark Rossi, Josh Toberman и другим из команды Facebook Video Productions за запись видео для основной презентации и докладов сотрудников Meta.
