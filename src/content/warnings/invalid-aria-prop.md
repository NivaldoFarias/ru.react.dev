---
title: Предупреждение о недопустимом ARIA-пропе
---

Это предупреждение появится, если вы попытаетесь отрендерить DOM-элемент с `aria-*` пропом, которого нет в спецификации [Web Accessibility Initiative (WAI) Accessible Rich Internet Application (ARIA)](https://www.w3.org/TR/wai-aria-1.1/#states_and_properties).
